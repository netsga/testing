...
*/
INSERT INTO `tbl_leaf_information` (`method`,`source_name`,`type`,`body`,`description`,`header`,`url`) VALUES ('getDeviceData','hems','http_get',NULL,'http_get.getDeviceData(localhems,$params, ...)','Content-Type:application/json;charset=utf-8|user-id:${userId}','http://localhost:8080/devices/#{ldId}/data?tags=${convTag}');
...
INSERT INTO `tbl_leaf_information` (`method`,`source_name`,`type`,`body`,`description`,`header`,`url`) VALUES ('setDeviceData','hems','http_post','{\\\"request\\\":{\\\"test\\\":#{value}}}','http_post.setDeviceData(localhems, $params, ...)',NULL,'http://localhost:8080/devices/#{ldId}');
